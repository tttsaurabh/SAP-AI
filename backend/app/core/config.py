...
class Settings(BaseSettings):
    ...
    CORS_ALLOWED_ORIGINS: str = "http://localhost:3000,http://127.0.0.1:3000,http://localhost:3001,http://127.0.0.1:3001,http://192.168.1.6:3000,http://192.168.1.7:3001,https://mdgbuddy.vercel.app"
